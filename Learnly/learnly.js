const bot = function () {
    ...
    const learnly = document.getElementById('learnly');
    const container = document.getElementById('learnly-container');
    const inner = document.getElementById('learnly-inner');
    ...
    const insertNewChatItem = function (elem) {
        //container.insertBefore(elem, learnly);
        learnly.appendChild(elem);
        scrollContainer();
        //debugger;
    ...
    const handleChoice = async function (e) {
        ...
        if (!e.target.classList.contains('choice') || 'A' === e.target.tagName) {
            ...
            var button = e.target.closest('#learnly-container .choice');
